...
@Disabled
@Configurable
//@TeleOp(name = "BurrritoAuto_Blue")
@Autonomous(name = "BurrritoAuto_Blue")
public class BurrritoAuto_Blue extends LinearOpMode {

    // panels: http://192.168.43.1:8001/
    private Follower _follower;
    private TelemetryManager _telemetryM;
    private BurrritoIntake _intake;
    ...
    private Pose _scorePose = new Pose(0.0, 60.0, Math.toRadians(135));  // scoring position
    private Pose _startPickup1Pose = new Pose(-10.0, 50.0, Math.toRadians(0));  // first pickup
    ...
    private Pose _stopPickup1Pose = new Pose(-15.0, 50.0, Math.toRadians(0));  // first pickup
    ...
    private void initRobot() throws InterruptedException {
        ...
        _follower = BurrritoConstants.createFollower(hardwareMap);
