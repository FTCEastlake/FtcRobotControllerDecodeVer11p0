...
public class BurrritoAuto extends LinearOpMode {
    ...
    private Pose scorePose = new Pose(0.0, 0.0, Math.toRadians(30));  // scoring position
    private Pose pickup1Pose = new Pose(0.0, 0.0, Math.toRadians(60));  // first pickup
    private Pose pickup2Pose = new Pose(0.0, 0.0, Math.toRadians(90));  // second pickup
    private Pose pickup3Pose = new Pose(0.0, 0.0, Math.toRadians(150));  // third pickup
...
//                pickup3Pose = new Pose(12.0 * tileScaleFactor, -108.0 * tileScaleFactor, Math.toRadians(0)); // move to -108 inches right, turn 0 degrees
                startPose = new Pose(0.0, 0.0, Math.toRadians(0.0));  // Start Pose of our robot.
                scorePose = new Pose(0.0 * tileScaleFactor, 0.0 * tileScaleFactor, Math.toRadians(45)); // move to -48 inches right, turn 45 degrees counter clockwise
                pickup1Pose = new Pose(0.0 * tileScaleFactor, 0.0 * tileScaleFactor, Math.toRadians(90)); // move to -60 inches right, turn 0 degrees
                pickup2Pose = new Pose(0.0 * tileScaleFactor, 0.0 * tileScaleFactor, Math.toRadians(135)); // move to -84 inches right, turn 0 degrees
                pickup3Pose = new Pose(0.0 * tileScaleFactor, 0.0 * tileScaleFactor, Math.toRadians(175)); // move to -108 inches right, turn 0 degrees
                break;
