...
//@Disabled
@Configurable
@TeleOp(name = "EggBasic")
public class EggBasic extends LinearOpMode {
    ...
    private void initPinpoint() {
        ...
        _pinpoint.setOffsets(6.625, -0.125, DistanceUnit.INCH);
         ...
         */
        _pinpoint.setEncoderDirections(GoBildaPinpointDriver.EncoderDirection.REVERSED,
